...
return [
 ...
 'board_validation_chunk_size'=>(int)env('VIVA_BOARD_VALIDATION_CHUNK_SIZE',2000),
 'board_merge_chunk_size'=>(int)env('VIVA_BOARD_MERGE_CHUNK_SIZE',1500),
 'operational_statuses'=>['active','cancelled','withheld','expelled'],
 'processing_chunk_size'=>(int)env('VIVA_PROCESSING_CHUNK_SIZE',2000),
];
