...
return [
    ...
    'divisions' => [
        ...
        'route' => 'registration-masters.index',
        'route_parameters' => ['type' => 'divisions'],
        'unique_by' => 'code',
        'additional_unique_by' => [],
        'headers' => ['code', 'name', 'name_bn', 'is_active'],
        'required' => ['code', 'name'],
        'sample' => [1, 'Dhaka', 'ঢাকা', 1],
    ],
    'districts' => [
        'label' => 'Districts',
        'model' => \App\Models\District::class,
        'route' => 'registration-masters.index',
        'route_parameters' => ['type' => 'districts'],
        'unique_by' => 'code',
        'additional_unique_by' => [],
        'headers' => ['code', 'division_code', 'name', 'name_bn', 'is_active'],
        'required' => ['code', 'division_code', 'name'],
        'sample' => [1, 1, 'Dhaka', 'ঢাকা', 1],
    ],
    'universities' => [
        'label' => 'Universities',
        'model' => \App\Models\University::class,
        'route' => 'registration-masters.index',
        'route_parameters' => ['type' => 'universities'],
        'unique_by' => 'code',
        'additional_unique_by' => [],
        'headers' => ['code', 'name', 'name_bn', 'is_active'],
        'required' => ['code', 'name'],
        'sample' => [1, 'University of Dhaka', 'ঢাকা বিশ্ববিদ্যালয়', 1],
    ],
];
