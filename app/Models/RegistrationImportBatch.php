...
final class RegistrationImportBatch extends ExaminationModel
{
    protected $fillable = [
        ...
        'current_row', 'chunk_size', 'current_chunk', 'total_chunks', 'progress_percent', 'inserted_rows',
        'updated_rows', 'failed_rows', 'warning_rows', 'identity_conflict_rows',
        'started_at', 'finished_at', 'rolled_back_at', 'rolled_back_by',
        'rollback_reason', 'error_file', 'failure_message', 'queued_at', 'heartbeat_at', 'created_by',
    ];
