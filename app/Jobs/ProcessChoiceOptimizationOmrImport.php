...
final class ProcessChoiceOptimizationOmrImport implements ShouldQueue
{
    ...
    public function handle(ExaminationConnectionManager $connections, ChoiceOptimizationOmrImportService $service): void
    {
