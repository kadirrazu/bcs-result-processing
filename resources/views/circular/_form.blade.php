...
<div class="row g-3">
 ...
 @isset($entry)<div class="col-12"><label class="form-label required">Reason for correction</label><textarea name="correction_reason" class="form-control" rows="3" required>{{ old('correction_reason') }}</textarea></div>@endisset
</div>
@push('scripts')
<script>
(function(){
