@extends('layouts.app')
@section('content')
<div class="page-header d-print-none"><div class="container-xl"><div class="row g-2 align-items-center"><div class="col"><h2 class="page-title">A8 — Dynamic Excel Export Builder</h2><div class="text-secondary">Build one combined workbook from selected finalized module fields.</div></div><div class="col-auto ms-auto"><a class="btn btn-outline-secondary" href="{{ route('allocation.a6.index') }}">Back to A8 — Allocation Reporting &amp; Export</a></div></div></div></div>
