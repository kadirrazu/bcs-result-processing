...
<div class="csr-wrap">
    ...
    <div class="csr-grid">
        ...
        <a class="csr-tile {{ $ready?'':'is-disabled' }}" href="{{ $ready?route('examination-reports.cadre.verification',['type'=>'general']):'#' }}">
            <span class="csr-number">02</span><span class="csr-copy"><span class="csr-name">General Cadre Candidate Allocation Report (GG + GN + GT)</span><span class="csr-desc d-block">Full finalized General Merit population and allocation evidence.</span></span><span class="csr-arrow">›</span>
        </a>
        <a class="csr-tile {{ $ready?'':'is-disabled' }}" href="{{ $ready?route('examination-reports.cadre.verification',['type'=>'technical']):'#' }}">
            <span class="csr-number">03</span><span class="csr-copy"><span class="csr-name">Technical Cadre Candidate Allocation Report (TT + T + GT)</span><span class="csr-desc d-block">Full finalized Technical Merit population and allocation evidence.</span></span><span class="csr-arrow">›</span>
        </a>
        <a class="csr-tile {{ $ready?'':'is-disabled' }}" href="{{ $ready?route('examination-reports.cadre.verification',['type'=>'technical-only']):'#' }}">
            <span class="csr-number">04</span><span class="csr-copy"><span class="csr-name">Only Technical Cadre Candidate Allocation Report (TT + T)</span><span class="csr-desc d-block">Effective TT + T technical-only population.</span></span><span class="csr-arrow">›</span>
        </a>
        <a class="csr-tile {{ $ready?'':'is-disabled' }}" href="{{ $ready?route('examination-reports.cadre.verification',['type'=>'quota']):'#' }}">
            <span class="csr-number">05</span><span class="csr-copy"><span class="csr-name">Quota Candidate Allocation Verification Report</span><span class="csr-desc d-block">CFF, EM and PHC candidates with allocation outcome and missed-choice evidence.</span></span><span class="csr-arrow">›</span>
        </a>
        <a class="csr-tile {{ $ready?'':'is-disabled' }}" href="{{ $ready?route('examination-reports.cadre.verification.general-cadre-wise'):'#' }}">
            <span class="csr-number">06</span><span class="csr-copy"><span class="csr-name">General Cadre-wise Allocation Verification Reports</span><span class="csr-desc d-block">Search and open a verification report for a General cadre.</span></span><span class="csr-arrow">›</span>
        </a>
        <a class="csr-tile {{ $ready?'':'is-disabled' }}" href="{{ $ready?route('examination-reports.cadre.verification.technical-cadre-wise'):'#' }}">
            <span class="csr-number">07</span><span class="csr-copy"><span class="csr-name">Technical Cadre-wise Allocation Verification Reports</span><span class="csr-desc d-block">Search and open a cadre-specific Technical merit report.</span></span><span class="csr-arrow">›</span>
        </a>
        <a class="csr-tile {{ $ready?'':'is-disabled' }}" href="{{ $ready?route('examination-reports.cadre.verification.cadre-serial-merit'):'#' }}">
            <span class="csr-number">08</span><span class="csr-copy"><span class="csr-name">Cadre-wise Serial, Merit &amp; Allocation Basis Report</span><span class="csr-desc d-block">Compact publication-order serial, merit and allocation basis verification.</span></span><span class="csr-arrow">›</span>
        </a>
    </div>
    ...
    <div class="csr-grid">
        ...
        <a class="csr-tile {{ $ready?'':'is-disabled' }}" href="{{ $ready?route('examination-reports.cadre.booklet',['type'=>'general']):'#' }}">
            <span class="csr-number">02</span><span class="csr-copy"><span class="csr-name">General Cadre Candidate Allocation Report (GG + GN + GT)</span><span class="csr-desc d-block">Full finalized General Merit population for booklet printing.</span></span><span class="csr-arrow">›</span>
        </a>
        <a class="csr-tile {{ $ready?'':'is-disabled' }}" href="{{ $ready?route('examination-reports.cadre.booklet',['type'=>'technical']):'#' }}">
            <span class="csr-number">03</span><span class="csr-copy"><span class="csr-name">Technical Cadre Candidate Allocation Report (TT + T + GT)</span><span class="csr-desc d-block">Full finalized Technical Merit population for booklet printing.</span></span><span class="csr-arrow">›</span>
        </a>
        <a class="csr-tile {{ $ready?'':'is-disabled' }}" href="{{ $ready?route('examination-reports.cadre.booklet',['type'=>'technical-only']):'#' }}">
            <span class="csr-number">04</span><span class="csr-copy"><span class="csr-name">Only Technical Cadre Candidate Allocation Report (TT + T)</span><span class="csr-desc d-block">Effective TT + T technical-only booklet population.</span></span><span class="csr-arrow">›</span>
        </a>
        <a class="csr-tile {{ $ready?'':'is-disabled' }}" href="{{ $ready?route('examination-reports.cadre.booklet',['type'=>'quota']):'#' }}">
            <span class="csr-number">05</span><span class="csr-copy"><span class="csr-name">Quota Candidate Allocation Report</span><span class="csr-desc d-block">CFF, EM and PHC candidates with identity and allocation outcome.</span></span><span class="csr-arrow">›</span>
        </a>
        <a class="csr-tile {{ $ready?'':'is-disabled' }}" href="{{ $ready?route('examination-reports.cadre.booklet.general-cadre-wise'):'#' }}">
            <span class="csr-number">06</span><span class="csr-copy"><span class="csr-name">General Cadre-wise Allocation Reports</span><span class="csr-desc d-block">Search and open a General cadre booklet report.</span></span><span class="csr-arrow">›</span>
        </a>
        <a class="csr-tile {{ $ready?'':'is-disabled' }}" href="{{ $ready?route('examination-reports.cadre.booklet.technical-cadre-wise'):'#' }}">
            <span class="csr-number">07</span><span class="csr-copy"><span class="csr-name">Technical Cadre-wise Allocation Reports</span><span class="csr-desc d-block">Search and open a cadre-specific Technical booklet report.</span></span><span class="csr-arrow">›</span>
        </a>
    </div>
</div>
@endsection
