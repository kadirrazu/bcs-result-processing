...
<td class="text-center align-middle">{{ $r->choice_position ?: '—' }}</td><td class="text-center align-middle">{{ $r->allocation_basis ?: '—' }}</td><td class="align-middle small">{{ $r->decision_reason ?: '—' }}</td>
