...
<thead><tr class="text-center align-middle"><th>SL</th><th>Common Merit</th>@if($mode==='booklet')<th class="text-start">Candidate Information</th>@endif<th>Allocation Ready Choice</th><th>Choice Position</th><th>Candidate Quota</th><th>Final Allocation</th><th>Basis</th></tr></thead>
