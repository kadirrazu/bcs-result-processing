...
<div class="container-xl">
    ...
    <div class="card mb-4">
        ...
        @foreach($postSummary as $p)<tr><td class="text-center">{{ $p->post_grade ?: '—' }}</td><td class="text-center">{{ $p->post_sub_serial ? $p->post_serial.'.'.$p->post_sub_serial : $p->post_serial }}</td><td class="text-center"><strong>{{ $p->post_code }}</strong></td><td>{{ $p->post_title }}</td><td class="text-center"><strong>{{ $p->post_count }}</strong></td><td class="text-center">{{ $p->mq_post ?? 0 }}</td><td class="text-center">{{ $p->cff_post ?? 0 }}</td><td class="text-center">{{ $p->em_post ?? 0 }}</td><td class="text-center">{{ $p->phc_post ?? 0 }}</td><td class="text-center"><strong>{{ $p->allocated }}</strong></td><td class="text-center">{{ $p->mq_allocated }}</td><td class="text-center">{{ $p->cff_allocated+$p->em_allocated+$p->phc_allocated }}</td><td class="text-center"><strong>{{ $p->vacant }}</strong></td></tr>@endforeach
        </tbody></table></div>
    </div>
