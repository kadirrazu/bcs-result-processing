...
<div class="page-header d-print-none"><div class="container-xl"><div class="row g-2 align-items-center">
    ...
    <div class="col-auto ms-auto d-flex gap-2"><a class="btn btn-outline-secondary" href="{{ route('written.index') }}">Back to Written</a><a class="btn btn-outline-primary" href="{{ route('written.final-result.combined.txt') }}">Download TXT</a><a class="btn btn-outline-success" href="{{ route('written.exports.xlsx', ['scope'=>'qualified','order'=>'reg','direction'=>'asc']) }}">Download XLSX</a><a class="btn btn-outline-success" href="{{ route('written.final-result.template') }}">Fill Result Template</a><button class="btn btn-primary" onclick="window.print()">Print</button></div>
</div></div></div>
