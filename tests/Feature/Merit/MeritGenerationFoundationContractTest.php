...
final class MeritGenerationFoundationContractTest extends TestCase
{
 ...
 public function test_merit_gate_uses_hash_verified_tabulation_and_circular_authorities():void{$r=file_get_contents(app_path('Services/Merit/MeritReadinessService.php'));foreach(['CircularFinalizedDatasetService','TabulationFinalizedDatasetService','dataset_hash'] as $x)$this->assertStringContainsString($x,$r);}
}
