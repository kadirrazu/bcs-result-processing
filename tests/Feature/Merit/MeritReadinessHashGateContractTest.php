...
final class MeritReadinessHashGateContractTest extends TestCase
{
 ...
 public function test_choice_validation_does_not_stale_merit():void{$graph=file_get_contents(app_path('Services/Dependencies/DownstreamStalePropagationService.php'));$this->assertStringContainsString("'choice_validation' => ['choice_optimization', 'allocation']",$graph);}
}
