...
final class NonCadreAllocationNc4StagedContractTest extends TestCase
{
 #[Test] public function nc4_is_staged_and_phase2_contains_nm_shifting_contract():void{
  ...
  foreach(['function freeze(','function phase1(','function phase2(','function validate(','convertedQuota','QUOTA_TO_MERIT','SHIFTED','NM','NO_CADRE_ALLOCATED_CANDIDATE','ALLOCATION_READY_CHOICE','SEAT_CONSERVATION'] as $x)$this->assertStringContainsString($x,$s);
 }
