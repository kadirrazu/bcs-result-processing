...
{
    public function test_landing_and_a3_a4_reviews_share_the_locked_ui_contract(): void
    {
        ...
        // Landing chronology is visually explicit: preliminary Seat Breakup, then A1 -> A4.
        ...
        $this->assertStringContainsString('View A3 Result', $index);
        $this->assertStringContainsString('btn btn-sm btn-success', $index);

        // Both ledger screens use the same combined search + exact dropdown contract.
        ...
        // A4 now mirrors A3 summary cards while exposing A4-specific movement statistics.
        ...
        // Seat ledgers collapse code + abbreviation into one compact Cadre column.
        $this->assertStringContainsString('<th>Cadre</th>', $a3);
        $this->assertStringContainsString('<th>Cadre</th>', $a4);
        $this->assertStringNotContainsString('<th>Cadre Abbreviation</th>\n            <th>Cadre Code</th>', $a3);
        $this->assertStringNotContainsString('<th>Cadre Abbreviation</th><th>Cadre Code</th>', $a4);
    }
}
