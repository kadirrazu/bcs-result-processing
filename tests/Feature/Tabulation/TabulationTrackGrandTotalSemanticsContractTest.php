...
final class TabulationTrackGrandTotalSemanticsContractTest extends TestCase
{
    ...
    {
        $this->assertSame('TRACK_FAILED', TabulationResult::grandTotalDisplayFor('GN', 'technical', null));
        $this->assertSame('TRACK_FAILED', TabulationResult::grandTotalDisplayFor('T', 'general', null));
        $this->assertSame('NOT_APPLICABLE', TabulationResult::grandTotalDisplayFor('GG', 'technical', null));
        $this->assertSame('NOT_APPLICABLE', TabulationResult::grandTotalDisplayFor('TT', 'general', null));
