...
final class CadreSerialMeritVerificationContractTest extends TestCase
{
    public function test_cadre_serial_merit_basis_report_contract(): void
    {
        ...
        self::assertStringContainsString('size: A4 landscape', $view);
        ...
        self::assertStringContainsString('colspan="9"', $view);
        ...
        self::assertStringContainsString("$mpdf->AddPage('L')", $pdf);
